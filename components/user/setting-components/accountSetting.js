...
const AccountSetting = () => {
  ...
  return (
    <>
      <div className="w-full xl:mx-24 mx-16">
      ...
      <div className="w-full xl:mx-24 mx-16 my-16">
            ...
            <select
              ...
              onChange={({ target }) => {
                if (target.value === "Select") {
                  ...
                  setSelectedCurrencySymbol(currencyList[target.value].symbol);
                }
              }}
        ...
        <div className="flex flex-col items-start space-y-3 my-20">
          <button type="button" className="text-xl text-[#A2B0B2] underline">
            Change Password
          </button>
          <button type="button" className="text-xl text-[#A2B0B2] underline">
            Delete Account
