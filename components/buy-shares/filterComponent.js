            ...
            {index === 0 && (
              <div className="relative">
                <button
                  ...
                  className="xxl:w-96 xl:w-64 lg:w-52 md:w-52 sm:w-36 bg-transparent p-3 lg:text-xl md:text-base sm:text-sm text-[#676767] flex items-center justify-between"
                >
                  Property Type{" "}
