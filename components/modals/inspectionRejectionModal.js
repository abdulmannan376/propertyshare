...
const RejectionModal = ({
  ...
  const handleInspectionAction = async () => {
    try {
      const data = {
        inspectionID: inspectionActionBody.inspectionID,
        username: inspectionActionBody.ownerUsername,
        occurence: inspectionActionBody.occurence,
        action: inspectionActionBody.action,
      };
